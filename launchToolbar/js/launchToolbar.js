...
(function () {
     ...
     */
        ...
        'buildSettings': function () {
            ...
            var $quickLinksSizingCheckboxIcon = launchToolbar.config.$settingCheckboxIcon.clone()
                .addClass('quickLinksSize');
            var $largeInfo = launchToolbar.config.$container.clone(true)
                .addClass('largeInfo')
                .text('make important info pop');
            var $largeInfoCheckboxIcon = launchToolbar.config.$settingCheckboxIcon.clone()
                .addClass('largeInfo');
            var $colorizeLaunch = launchToolbar.config.$container.clone(true)
                .addClass('colorizeLaunch')
                .text('highlight important info');
            var $colorizeLaunchCheckboxIcon = launchToolbar.config.$settingCheckboxIcon.clone()
                .addClass('colorizeLaunch');
            ...
            var $colorStartInputField = launchToolbar.config.$settingInput.clone(true)
                .addClass('startColor changeToolColor');
            var $colorEndInputField = launchToolbar.config.$settingInput.clone(true)
        ...
        'getBAC': function () {
            ...
            setInterval(function () {
                ...
                if (location.indexOf('cdk--c.na57.visual.force.com') > -1) {
                    ...
                    accountName = jQuery.
                        trim(accountNameText.slice(0, accountNameText.indexOf('[')));
