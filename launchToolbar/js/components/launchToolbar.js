...
const launchToolbar = (function() {
  ...
  var launchToolbar = {
    ...
    buildSettings() {
      var $otherSettings = launchToolbar.config.$container
        .clone(true)
        .text("Other Features")
        .removeClass("click-able");
      var $settingsArrow = launchToolbar.config.$arrowIcon.clone(true);
      var $quickLinksSizing = launchToolbar.config.$container
        .clone(true)
      ...
      var $quickLinksSizingCheckboxIcon = launchToolbar.config.$settingCheckboxIcon
        .clone()
        .addClass("quickLinksSize");
      var $largeInfo = launchToolbar.config.$container
        .clone(true)
        .addClass("largeInfo")
      ...
      var $largeInfoCheckboxIcon = launchToolbar.config.$settingCheckboxIcon
        .clone()
        .addClass("largeInfo");
      var $colorizeLaunch = launchToolbar.config.$container
        .clone(true)
      ...
      var $colorizeLaunchCheckboxIcon = launchToolbar.config.$settingCheckboxIcon
        .clone()
        .addClass("colorizeLaunch");
      var $colorTool = launchToolbar.config.$container
        .clone(true)
      ...
      var $colorInputFieldButt = launchToolbar.config.$myButt
        .clone(true)
        .addClass("changeToolColor")
        .text("submit");
    ...
    openAccountPageLink(event) {
      var $clickedElement = jQuery(event.delegateTarget);
      var classText = $clickedElement.attr("class");
      var accountPageLink = jQuery("#CF00N40000002aUDp_ileinner > a").attr(
        "href"
      );
